...
tinymce.PluginManager.add('image', function(editor) {
  ...
  function showDialog(imageList) {
    ...
    if (imgElm.nodeName == 'IMG' && !imgElm.getAttribute('data-mce-object') && !imgElm.getAttribute('data-mce-placeholder')) {
      var marginBottom = parseInt(imgElm.style.marginBottom);
      var marginLeft = parseInt(imgElm.style.marginLeft);
      var marginRight = parseInt(imgElm.style.marginRight);
      var marginTop = parseInt(imgElm.style.marginTop);
      data = {
        ...
        items: [
          {
            ...
            items: [
              {type: 'label', text: 'Top'},
              {name: 'margin-top', type: 'textbox', maxLength: 5, size: 3
              }
            ]
          },
          {
            ...
            items: [
              ...
              {name: 'margin-right', type: 'textbox', maxLength: 5, size: 3
              }
            ]
          },
          {
            ...
            items: [
              ...
              {name: 'margin-bottom', type: 'textbox', maxLength: 5, size: 3
              }
            ]
          },
          {
            ...
            items: [
              ...
              {name: 'margin-left', type: 'textbox', maxLength: 5, size: 3
              }
            ]
          },
        ]
